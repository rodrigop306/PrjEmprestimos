	...
	<script>
		function remover( id ) {
			if (confirm("Remove o sorvete com id " + id)) {
				$('#formUsuario').empty();
				$('#formUsuario').append('<input type="hidden" name="txtId" value="' + id + '"/>');
				$('#formUsuario').append('<input type="hidden" name="cmd" value="remover"/>');
				$('#formUsuario').submit();
			}
		}
	</script>
...
<body>
	...
	<form id="formUsuario" action="./SorveteController" method="post">
		<div class="container">
